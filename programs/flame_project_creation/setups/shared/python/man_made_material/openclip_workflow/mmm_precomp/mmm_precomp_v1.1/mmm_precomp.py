...
Menus:
    ...
    Setup:
        ...
        Flame 2023.2+:
            ...
            Flame Main Menu -> MMM_utilities -> MMM_configuration -> mmm_precomp_setup
...
class class_mmm_precomp():
    ...
    def media_panel_mmm_precomp_clips(self):
        ...
        # Create batch group
        batch_group = flame.batch.create_batch_group('mmm_precomp', reels=['sources','precomp','mattes','neat_video','comp'])
