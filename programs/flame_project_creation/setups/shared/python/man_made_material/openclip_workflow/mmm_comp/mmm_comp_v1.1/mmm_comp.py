...
Menus:
    ...
    Setup:
        ...
        Flame 2023.2+:
            ...
            Flame Main Menu -> MMM_utilities -> MMM_configuration -> mmm_comp_setup
...
class class_mmm_comp():
    ...
    def media_panel_mmm_comp_clips(self):
        ...
        # Create batch group
        batch_group = flame.batch.create_batch_group('mmm_comp', reels=['sources','precomp','mattes','neat_video','comp'])
