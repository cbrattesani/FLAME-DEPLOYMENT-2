...
Menus:
    ...
    Setup:
        ...
        Flame 2023.2+:
            ...
            Flame Main Menu -> MMM_utilities -> MMM_configuration -> mmm_mattes_setup
...
class class_mmm_mattes():
    ...
    def media_panel_mmm_mattes_clips(self):
        ...
        # Create batch group
        batch_group = flame.batch.create_batch_group('mmm_mattes', reels=['sources','precomp','mattes','neat_video','comp'])
