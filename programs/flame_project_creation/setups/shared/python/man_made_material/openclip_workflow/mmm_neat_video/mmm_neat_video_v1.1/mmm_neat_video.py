...
Menus:
    ...
    Setup:
        ...
        Flame 2023.2+:
            ...
            Flame Main Menu -> MMM_utilities -> MMM_configuration -> mmm_neat_video_setup
...
class class_mmm_neat_video():
    ...
    def batch_mmm_neat_video_clips(self):
        ...
        # Define reel names
        reel_names = ["sources", "mattes", "neat_video", "precomp", "comp"]
    ...
    def media_panel_mmm_neat_video_clips(self):
        ...
        # Create batch group
        batch_group = flame.batch.create_batch_group('mmm_neat_video', reels=['sources','precomp','mattes','neat_video','comp'])
...
def get_main_menu_custom_ui_actions():
    ...
    return [
        {
            'name': 'MMM_configuration',
            'actions': [
                {
                    'name': 'mmm_neat_video Setup',
                    'execute': setup,
                    'minimumVersion': '2022',
